    ...
    stack: {
      ...
      'growth-data': {
        ChatWeeklyReportPage: {
          ...
          interests: {
            title: '小小故事家与动物守护者',
            growthSignal: '成长信号：绵绵正处于象征游戏的高峰期，通过角色扮演和虚构情节，她在学习理解世界、表达情绪、建立道德观念。',
          ...
          emotion: {
            title: '温暖、调皮，偶尔小焦虑',
            growthSignal: '成长信号：绵绵正在学习情绪调节与共情。她能通过故事表达担忧，也能在互动中获得安全感。',
          ...
          lebotRole: {
            title: '耐心的玩伴与情绪容器',
            growthSignal: '乐宝的价值：它成为绵绵可以完全掌控的"玩伴"，让绵绵在安全的关系中练习语言、表达情绪、构建自信。',
        ...
        CapabilityDetailPage: {
          ...
          comparison: {
            ...
            vertical: '纵向对比',
            verticalSub: '（自身发展轨迹）',
            advantage1: '叙事想象力丰富——能自主构建多角色奇幻场景（如"变成水龙裹住地球""与孙悟空互动"），远超5岁儿童平均叙事水平。',
            advantage2: '情感传达生动——通过夸张表达（如"臭哪吒""帅气的哪吒"）和语气词（如"哈哈哈"）有效传递情绪。',
            disadvantage1: '逻辑衔接较弱——事件切换频繁（如从"拉屎"突然跳至"孙悟空"），因果关联性低。',
      ...
      DeviceConfigPage: {
        labels: {
          ...
          deleteConfirmBody: '删除设备的同时，该设备绑定的儿童家庭组、聊天记录、成长报告等都将一并删除，确定删除吗？',
          confirmDelete: '确定',
        },
        notifications: {
      ...
      settings: {
        ...
        TermsOfServicePage: {
          ...
          content: {
            ...
            title2: '二、服务说明',
            body2: '乐宝 AI 机器人为用户提供智能语音对话服务，包括语音识别、自然语言处理和语音合成等功能。',
            title3: '三、用户账号',
            body3: '用户需要注册账号才能使用完整功能。用户应妥善保管账号信息，因账号被盗用造成的损失由用户自行承担。',
            title4: '四、使用规范',
            body4: '用户不得利用本服务从事违法违规活动，不得传播违法、有害、骚扰性、伤害性、歧视性内容。',
            title5: '五、服务变更',
            body5: '我们保留随时修改或中断服务的权利，并会提前通知用户。因服务变更造成的损失，我们不承担责任。',
            title6: '六、争议解决',
        ...
        UserAgreementPage: {
          ...
          content: {
            title1: '一、协议范围',
            body1: '本协议是用户与乐宝之间关于使用 AI 机器人服务的法律协议。用户使用服务即表示同意本协议的所有条款。',
            title2: '二、用户权利',
            body2: '用户享有正常使用服务的权利，有权享受我们提供的各项功能和服务更新。',
            title3: '三、用户义务',
            body3: '用户需保证所提供信息的真实性和合法性，不得利用服务进行任何非法活动。',
            title4: '四、免责声明',
            body4: 'AI 机器人提供的回答仅供参考，不构成任何形式的建议。我们不对用户因使用服务造成的任何损失负责。',
            title5: '五、终止服务',
