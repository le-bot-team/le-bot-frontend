      ...
      voiceprint: {
        ...
        SubmitPanel: {
          ...
          notifications: {
            ...
            duplicateVoiceprintTitle: '声纹已存在',
            duplicateVoiceprintBody:
              '系统检测到该声音与已注册的「{name}」声纹高度相似（置信度 {confidence}%）。无法重复添加相同声纹，请重新录制不同的声音。',
            duplicateConfirmLabel: '我知道了',
          },
        },
      },
    },
    ...
    stack: {
      ...
      AddVirtualDevicePage: {
        ...
        notifications: {
          ...
          duplicateChildName: '该儿童已拥有虚拟乐宝，无法重复添加',
          duplicateVoiceprint: '该声纹已关联到现有儿童，无法重复添加',
          duplicateChildHint:
            '当前系统暂不支持一个儿童对应多个设备。您可以在设备设置中调整语音、语调及个性化配置，或在家庭组中编辑儿童信息。',
          duplicateConfirmLabel: '我知道了',
          linkDeviceConfig: '前往设备设置',
          linkChildEdit: '编辑儿童信息',
      ...
      chat: {
        ChatHistoryPage: {
          labels: {
            ...
            growthSignal: '成长信号',
            empty: '暂无聊天摘要',
            comingSoon: '聊天摘要功能即将上线',
            emptyTitle: '今天还没有聊天记录哦',
            emptySubtitle: '和乐宝聊聊天，看看今天有什么新发现吧~',
            goChat: '去聊天',
            loadFailed: '获取摘要失败',
            retry: '重试',
            loading: '加载中...',
